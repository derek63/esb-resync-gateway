...
@Component
public class JmsGenericConfiguration {

    private String endSystem;
    private JmsTemplate broker;
    private String genericQueue;

    public JmsGenericConfiguration() {

    }

    public JmsGenericConfiguration(String endSystem, JmsTemplate broker, String genericQueue) {
    ...
    public String getGenericQueue() {
        return genericQueue;
    }

    public void setGenericQueue(String genericQueue) {
        this.genericQueue = genericQueue;
    }
